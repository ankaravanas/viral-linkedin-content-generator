...
Add extra info without breaking sentence flowe.g. I offer two training formats: in-person (available in UK-only) or virtual (for global teams)
Provide alternative phrases or optionse.g. DM me if interested (or ping me an email: joe@company.com)
Clarify terms and phrasese.g. "The new compliance regs (GDPR) were tough to navigate”
Credit your sourcese.g. “SaaS companies that regularly blog generate 67% more leads than those that don’t (Hubspot report, 2023)”
...
That’s enough people to fill Barcelona FC's Camp Nou.”
“We didn’t just make $1M in revenue…
...
Known for: a fluid one-handed backhand and exceptional net play.
Djokovic’s plays with near-inhuman efficiency and agility.
Known for: a powerful two-handed backhand and outstanding return of serve.
Nadal played with ruthless aggression and power.
...
“If you’re wondering why your social media posts are falling on deaf ears…”

Makes a promise of what people will get if they keep reading:
“...I’ve got a hack for you…”

Teases exclusivity, heightening curiosity:
...
Intention - what is the main character’s goal? Whether that’s an individual, an entity, your reader, or you. In Stéphanie’s post: her goal (that she shares with her reader) is to build a creator business.

Obstacle - what stands in their way? Plain sailing doesn’t make for a good story. Conflict, challenges, obstacles are what keep people hanging off your every word.In Stéphanie’s post: her obstacles include no blueprint, huge uncertainty, and months of no clarity.

Resolution - how does it work out for them? The reader will want to know. You’ve built tension. Now it’s time to provide a satisfying resolve.In Stéphanie’s post: she presents powerful stories as a solution.
...
146. Is Your Advice Actually Actionable, Though?
Lara doesn’t just share some interesting ideas from a book. She goes one further.

She takes the 6 core principles from Dr. Cialdini’s book Influence, a book about the art of persuasion – and shows how to apply each principle to LinkedIn. Lara makes this information practical for people.

So whenever you share insights, ask yourself:

Is the advice I’m sharing actionable or abstract?
...
147. Digital Word Of Mouth (WOM)
In business, no words are more persuasive than those from a happy customer.

Client reviews (aka testimonials) are an incredibly powerful form of social proof. Any business can make well-worded claims about how great they are.

But when happy customers sing your praises, it makes any claims you make more believable. Testimonials show prospects that what you offer works for others like them. It’s proof of concept.

So remember to ask for, collect, and showcase testimonials.

Then feature them on your profile and in your content – like Justin does.
...
148. How To Work Smarter, Not Harder
Below, Jake speaks to how and why companies should optimise old blogs rather than create new ones. He suggests it’s an easier and faster way to unlock better SEO results.

Here’s the underlying principle: work smarter, not harder.

And while he talks about blogs, this principle holds true for all types of content.

Here are 5 ways you can work smarter, not harder, as a LinkedIn creator:

Plan out what content you’re going to create 1-2 weeks in advance - create a content calendar and decide ahead of time what you need to create. This avoids deciding on the day.
Repurpose your content - turn blogs, newsletters, or comments into posts. Tweak your top performing posts and publish them again. Reformat carousels into infographics, text posts, or videos (and vice-versa).
Batch write posts - block off 1-3 hour blocks in your calendar for writing content. If you can, create content at the same times each week.
Keep a swipe file - save great posts, hooks, and ideas to inspire you when you sit down to create.
Lean on proven post templates - to help structure your writing and beat the blank page.
Here’s the post template:
...
149. All Top 1% Creators Understand This
“The secret isn't how well you write. It's how well you use contrast.” – Taylin John Simmonds

Contrast is a powerful literary device. It can shift your writing from “meh” to “Wow, that’s so well written!” It makes your ideas, stories, and solutions more vivid, persuasive, and memorable.

Below, Codie contrasts her father’s ethical approach to business with his business partner’s selfish approach. This stark contrast adds tension, drama, and interest to the story – while reinforcing the over-arching lesson.

Some more ways to use contrast in your content:
...
Ethical vs. unethical (see Codie’s story)
Here’s the post template:
...
150. Reframing Negative Perspectives
Often, what stops people moving forward is the wrong mindset.

As a creator, it’s your job to identify common mental roadblocks that hold your prospects back. By referring to these in your content, your reader feels understood. They’ll resonate with what you’re saying, which evokes trust.

Next, take these negative mindsets and reframe them. Give your readers a new, helpful way to think about their problems. Leave them feeling optimistic – like Jasmin does…

"Always enter the conversation already occurring in the customer's mind" – Dan Kennedy
...
151. Wanna Make (More) Money On LinkedIn? Read This
You can waste 100s of hours on LinkedIn if you’re not careful.

Many creators chase engagement and LinkedIn fame. Then neglect what’s important (i.e. making money). LinkedIn is a *business* platform, after all.

Instead:

Focus on who you're creating content for. Avoid trying to please everyone. Start by solving one specific problem, for one specific person, in one specific way.
Focus on building relationships with peers and prospects. Your content may attract people into your orbit, but it’s on you to foster meaningful conversations.
Focus on revenue metrics (e.g. leads and conversions) over engagement metrics. For instance, if a prospect reaches out or buys from you, ask how they found you. Did a specific post get them over the line? Ask them.
For more money-making do’s and don’ts, see Nick’s post…
...
[First challenge]:[Explain the challenge – e.g. break a misconception and/or highlight what people miss]. [Expand on how to overcome challenge].

[Second challenge]:[Explain the challenge – e.g. break a misconception and/or highlight what people miss]. [Expand on how to overcome challenge].

[Third challenge]:[Explain the challenge – e.g. break a misconception and/or highlight what people miss]. [Expand on how to overcome challenge].
...
152. How To Twist The Knife (Making A Problem Hurt)
Below, Ali addresses a common problem creators face:

→ Trying to compete in a crowded market/niche.

However, he doesn’t just state the problem (like above).

First, he gives the problem a novel, catchy name: “Niche Saturation Syndrome” – which makes it more memorable, concrete.

Then, he lists 3 nagging frustrations that amplify the over-arching problem in his reader’s mind.

Here, Ali uses a copywriting trick known as ‘twisting the knife.’ By vividly describing these painful consequences, his readers FEEL the problem on a visceral level. It’s like holding up a mirror and saying, “I get how hard this is for you.”

This deepens the emotional connection, which makes the solution not just a nice-to-have but a life raft when it rolls around.
...
[A specific, actionable recommendation].[Explain on recommendation – what do people need to know, avoid, do? Keep advice concise and actionable].
...
153. How To Stand Out (Without Ruining Your Rep)
“I don’t believe that the meek will inherit the earth; The meek get ignored and trampled.” – Sylvia Plath (Poet, Author)

Share bold opinions.

Don’t be afraid to ruffle some feathers. Whether people agree or disagree, they’ll let you know either way – which means more reach and engagement. Win-win.

Some tips for effectively sharing bold opinions:

Share opinions you actually believe in. Avoid being devisive for the sake of it.
Pair opinions with valuable insight – like Liz. This helps soften any pushback.
Be bold but professional. Avoid being aggressive, vulgar, or overly negative.
Before you post, anticipate objections. Consider addressing these in-post.
End with an open-ended question. Show you’re open to other viewpoints.
Here’s the post template:
...
[Bold action 1][Expand on why this action is important, and give actionable advice].

[Bold action 2][Expand on why this action is important, and give actionable advice].

[Bold action 3][Expand on why this action is important, and give actionable advice].

[Bold action 4][Expand on why this action is important, and give actionable advice].

[Key takeaway].

154. Every Creator Should Use These (Advanced)
LinkedIn is NOT a reliable way to nurture prospects.

For one, they may not be online that often. And even if they are, there’s no guarantee they’ll see your content. After all, the feed is busy and only a small fraction of your audience ever sees your posts.

So what do you do? How can you stay in touch with interested parties who aren’t ready to buy yet?

Answer: Offer a lead magnet (a free content resource offered in exchange for a prospect’s contact info – usually an email). Once you have their email, you have a direct line to their email inbox.

Niall explains how to create a good one…

Here’s the post template:
I’ve [achieved specific success or milestone] in the last [short timeframe].
...
155. A Hook Tactic For 2025 (And Beyond)
Tying your advice to the year – like Nausheen does:

"5 poor speaking habits to eliminate in 2025."

…makes your content seem time-sensitive and current.

Using this hook tactic around the new year taps into our psychological drive for fresh starts, resolutions, and personal growth. That said, this tactic can also be effective year round.

Examples:

12 sales stats to help you sell smarter in 2025
5 reasons SaaS sales teams excelled in 2024
The fastest growing AI communities of 2024
Here’s the post template:
...
156. A Surefire Way To Improve Your Writing
Add specificity.

Is the athlete training?

Or is he running 400-meter sprints at 5:30 AM with a weighted vest, pushing for a personal best?

Is the venture capitalist reviewing a pitch?

Or is she scanning a 25-slide deck from a scrappy founder who bootstrapped to $1.3M ARR with zero paid marketing?

Vagueness saps energy. Add depth, colour, and believability to your words with:

Vivid language
Sensory details
Strong action verbs
And numbers, results, evidence (as Reno points out)
Here’s the post template:
...
157. A Trick To Fire Up Your Reader’s Brain
Tony Robbins is a freak of nature.

He's the No.1 life coach in the world.

His businesses do $7B in yearly revenue.

And he’s the highest paid public speaker of all time.

He engages audiences of thousands of people for 12+ hours a day across 4-6 day seminars.

Have you ever sat and listened to someone talk for 12 hours? Probably not, right? But the reason Tony can is because his audience doesn’t just sit there, passively consuming. They dance, move, scream, converse, and walk barefoot across molten coals.

They actively participate.

Here’s a great way to actively engage your (online) audience:

Ask reflective questions.

Below, Rachel lists 4 questions people can use when deciding on what meetings to attend. Her questions engage her reader’s mind. They help people self-diagnose problems. They empower decision-making.

So rather than just stating advice, pepper in questions to spark reflection.

Turn your audience from passive readers into active participants.
...
158. Unsure What To Write? Try This
Many aspiring creators never hit “Post” because they don’t know what to say.

If this sounds familiar, or if writer’s block plagues you, then try this:

Write to your past self.

Cast your mind back. Picture the challenges you once faced and overcame. It can be the you of 2+ years ago, or it can be the you from 2 days ago – it doesn’t matter.

Take Andy’s post. He received some rather blunt feedback on a sales call. Rather than puff up like a blowfish and sulk, he used this feedback to re-evaluate his approach. The result? 7 practical strategies to listen more on sales calls. Boom.

Use LinkedIn as an excuse to distill any useful knowledge trapped inside your head.

Over time, your mind will grow sharper, clearer. You’ll become a magnet for likeminded people. All while showcasing your problem-solving prowess to an audience of people actively looking to throw money at problems.

Write to your past self. Share your solution to yesterday’s problems.
...
159. A Timeless Copywriting Technique
Josue’s first sentence? 5 words.

He doesn’t cross this 5 word threshold for another 5 lines.

By which point, we’re hooked.

Herein lies The Slippery Slide Effect – a technique coined by copywriting legend Joe Sugarman.

The goal is get the reader flying down the page from the start. This lightens the cognitive load of reading. And enables quick, rewarding progress, which means the meat of your post stands more chance of being read.

To harness The Slippery Slide Effect:

Start posts with short, punchy sentences (≤ 9 words)
Keep paragraphs short (1-2 sentences max)
Avoid (or limit) long multisyllabic words
Break up lists into bullets
And use line breaks
Here’s the post template:
...
160. 7 Reasons Why This Post Went Viral
A breaking news hook that signals time-sentive information, involving a well-known company (OpenAI). Allie establishes urgency and authority in one fell swoop.

Teasing an insider’s perspective: “I was an early tester of the product…” Industry professionals are naturally drawn to exclusive insights that may give them an edge.

Setting clear expectations: "Let’s break down what it is, my views, why it matters, and what to do/expect." This tells the reader exactly what they’ll get.

Specific, relatable examples (see the Airbnb example) instead of vague descriptions. Examples make abstract concepts easier to grasp.

Tying insights to the larger industry trends. This not only showcases her expertise but also puts things in perspective for the reader.

Clear visual cues and formatting. Signpost headings, symbols to create visual flow, and compact paragraphs – all of which make for easier reading.

Offering a deeper resource (a webinar) for those interested in learning more about the topic.

All these content devices combine to make her post attention-grabbing, engaging, and valuable.

Why not weave some of these into your next post?
